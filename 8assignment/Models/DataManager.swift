...
class DataManager {
    ...
    private func getMusic() -> [FavoriteItem] {
        return [
            ...
            FavoriteItem(title: "Born to Run", subtitle: "Bruce Springsteen", review: "The Boss at his finest. Captures the spirit of youth, freedom, and the American dream perfectly.", imageURL: "https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f?w=800", description: "Rock anthem album about escape, hope, and the eternal search for something better beyond the horizon.", rating: 4.5, year: "1975")
        ]
    }
    
    private func getBooks() -> [FavoriteItem] {
        return [
            FavoriteItem(title: "1984", subtitle: "George Orwell", review: "A chilling dystopian masterpiece that feels more relevant than ever. Orwell's vision of totalitarianism is haunting and prophetic.", imageURL: "https://images.unsplash.com/photo-1495446815901-a7297e633e8d?w=800", description: "Dystopian novel depicting a totalitarian society under constant surveillance, thought control, and propaganda.", rating: 5.0, year: "1949"),
